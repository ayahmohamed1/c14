        ...
        >
          <div className="w-full pt-[24%] pb-[28%] px-[18%] sm:pt-[22%] sm:pb-[26%] sm:px-[22%]">
            ...
            <p className="font-letter text-[11.5px] sm:text-[15px] lg:text-[17px] leading-[1.9] sm:leading-[2.2] font-bold text-[#4a362f]">
             Happy 5 months to us ❤️‍🔥😂

5 months of laughs, chaos, stupid fights, beautiful memories and somehow still being each other’s favorite headache 😂❤️

I know the last part wasnt easy and I know I made mistakes, but Ill always appreciate every good moment we had 🫶🏻

I hope whats coming is better, calmer and full of the laughs we used to have ❤️‍🔥🌍

Happy 5 months, my favorite person and my favorite headache 😂❤️
            </p>
          </div>
        </div>
      </section>
